...
const PII_NAME_PATTERN =
  /\b(?:John|Jane|Robert|Mary|James|Patricia|Michael|Jennifer|William|Linda)\s+(?:Doe|Smith|Johnson|Williams|Brown|Jones|Garcia|Miller|Davis)\b/gi;
const ADDRESS_PATTERN =
  /\b\d{1,6}\s+[A-Za-z\s]{3,40}(?:Street|St|Avenue|Ave|Road|Rd|Boulevard|Blvd|Lane|Ln|Drive|Dr|Court|Ct|Place|Pl)\b/g;
const PRIVILEGED_PATTERN =
  /\b(?:attorney[- ]client privilege|work product|confidential communication|privileged and confidential)\b/gi;
